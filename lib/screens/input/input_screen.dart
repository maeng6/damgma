...
import 'package:dangma/repo/image_storage.dart';
import 'package:dangma/repo/item_service.dart';
import 'package:dangma/router/locations.dart';
import 'package:dangma/screens/input/multi_image_select.dart';
...
class _InputScreenState extends State<InputScreen> {
  ...
  void attemptCreateItem() async {
    ...
    ItemModel itemModel = ItemModel(
        ...
        category: context.read<CategoryNotifier>().currenCategoryInEng,
        price:  price??0,
            ...
            body: ListView(
              children: [
                ...
                ListTile(
                  ...
                  dense: true,
                  title: Text(
                      context.watch<CategoryNotifier>().currenCategoryInKor),
                ...
                Row(
                  children: [
                    ...
                    TextButton.icon(
                      ...
                      style: TextButton.styleFrom(
                          foregroundColor: _suggestPriceSelected
                              ? Theme.of(context).primaryColor
                              : Colors.black45,
